...
const markSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
  <circle cx="572" cy="452" r="320" fill="#2f6249"/>
  <circle cx="512" cy="512" r="320" fill="#e66b56"/>
  <g transform="translate(512 512) scale(1.46) translate(-128 -136)" fill="#ffffff"><path d="${PEOPLE_GLYPH}"/></g>
</svg>`;
