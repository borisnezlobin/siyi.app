...
/**
 * Your card: the code people scan, the address they reach you at, and the
 * choice of what they find there.
 *
 * It lives inside the Settings page rather than behind a link to somewhere
 * else, which is where the web puts it. The switch leads, because nothing
 * under it exists while it is off — so with it off, the rest is gone rather
 * than greyed. A disabled control still invites you to try it; an absent one
 * asks the only question worth asking, which is whether you want a page at
 * all.
 */
export function OwnCardSection() {
