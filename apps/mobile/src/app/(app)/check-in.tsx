...
export default function CheckInScreen() {
  ...
  const candidates = useMemo(
    () => checkInCandidates(screenData.data ?? [], new Date(), 24),
    [screenData.data],
  );
  ...
  return (
    ...
    >
      {candidates.length === 0 ? (
        <EmptyState
          body="Everyone you might have seen is already logged for today."
          icon={UsersThree}
          title="All caught up"
        />
      ) : (
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.rowBody}>
                    ...
                    <AppText variant="caption">{lastSeenLabel(person)}</AppText>
                  </View>
